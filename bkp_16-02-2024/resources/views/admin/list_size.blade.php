            ...
            <div class="col-sm-12">
                ...
                <div class="card card-table">
                    ...
                    <div class="card-body">
                        ...
                        <form id="form" action="{{ route('delete_size') }}" enctype="multipart/form-data">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($size as $size_data)
                                            ...
                                            <tr>
                                                ...
                                                <td><input name="selected[]" id="selected[]" value="{{ $size_data->id }}"
                                               ...
                                               @if (in_array('7', $edit_perm))
                                                    ...
                                                    <td class="text-right">
                                                        ...
                                                        <a class="btn btn-primary"
                                                            ...
                                                            href="{{ route('size.edit', $size_data->id) }}"><i
