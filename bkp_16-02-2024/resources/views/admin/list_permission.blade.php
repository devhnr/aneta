        ...
        <div class="page-header">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-auto">
                    ...
                    <a class="btn btn-primary me-1" href="{{ route('user_permission.create') }}">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($permission_data as $data)
                                            ...
                                            <tr>
                                                ...
                                                <!-- <td class="left"><input type="text" value="{{ $data->set_order }}" onblur="updateorder(this.value, '{{ $data->id }}');"  /></td> -->
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    <a class="btn btn-primary"
                                                        ...
                                                        href="{{ route('user_permission.edit', $data->id) }}"><i
