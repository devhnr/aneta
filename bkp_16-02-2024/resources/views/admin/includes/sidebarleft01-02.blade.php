<div class="sidebar-inner slimscroll">
    ...
    <div id="sidebar-menu" class="sidebar-menu">
        ...
        <ul>
            ...
            @if (in_array('1', $permission1) ||
                ...
                <li class="submenu">
                    ...
                    <a href="#"
                        class="{{ request()->segment(2) == 'category' || request()->segment(2) == 'subcategory' || request()->segment(2) == 'size' ? 'active' : '' }}"><i
        ...
        @if (in_array('11', $permission1))
            <li class="{{ request()->segment(2) == 'subbanner' ? 'active' : '' }}">

                <a href="{{ route('subbanner.index') }}"><i data-feather="file"></i> <span>Sub Banner</span></a>
