			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-body">
						...
						<form id="category_form" action="{{ route('subcategory.store') }}" method="POST" enctype="multipart/form-data">
							@csrf
							<div class="row">
								<div class="form-group">
									...
									<select name="cat_id" id="cat_id" class="form-control">
										...
										@foreach($all_category as $all_category_data)
											<option value="{{$all_category_data['id']}}">{{$all_category_data['name']}}</option>
										@endforeach
									</select>									
								</div>
