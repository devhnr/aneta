            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="category_form" action="{{ route('category.update', $category->id) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="page_url" name="page_url" type="text" class="form-control"
                                        placeholder="Enter Page Url" value="{{ $category->page_url }}" />
                                    <p id="page_url_error" style="display: none;color: red"></p>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="name">Image(135px x 85px)</label>
                                    <input id="image" name="image" type="file" class="form-control"
                                        value="" />

                                    @if ($category->image != '')
                                        <img src="{{ asset('public/upload/category/large/' . $category->image) }}"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="meta_keywords" name="meta_keywords"
                                        placeholder="Enter Meta Keywords" value="{{ $category->meta_keywords }}">
