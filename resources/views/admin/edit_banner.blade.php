            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('banner.index') }}">CMS</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <img src="{{ asset('public/upload/banner/large/'.$banner_data->image) }}" style="width: 50px;height:50px;"/>
                                    @endif
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="button_name" name="button_name" placeholder="Enter Button Name" value="{{$banner_data->button_name}}">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="button_link" name="button_link" placeholder="Enter Button Link" value="{{$banner_data->button_link}}">
