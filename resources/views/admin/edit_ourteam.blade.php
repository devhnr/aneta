            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="ourteam_form" action="{{ route('our_team.update', $our_team->id) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="role" name="role" type="text" class="form-control"
                                        placeholder="Enter Role" value="{{ $our_team->role }}" />
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($our_team->image != '')
                                        <img src="{{ asset('public/upload/our_team/large/' . $our_team->image) }}"
                            ...
                            <div class="text-end mt-4">
                                <a class="btn btn-primary" href="{{ route('our_team.index') }}"> Cancel</a>
                                <button type="button" class="btn btn-primary"
                                    onclick="javascript:ourteam_validation()">Submit</button>
