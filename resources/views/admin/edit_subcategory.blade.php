            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="category_form" action="{{ route('subcategory.update', $subcategory->id) }}" method="POST"
                               ...
                               <div class="form-group">
                                    ...
                                    <select name="cat_id" id="cat_id" class="form-control">
                                        ...
                                        @foreach ($all_category as $all_category_data)
                                            ...
                                            <option value="{{ $all_category_data['id'] }}"

                                                @if ($all_category_data['id'] == $subcategory->cat_id) {{ 'selected' }} @endif>

                                                {{ $all_category_data['name'] }}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="name" name="name" type="text" class="form-control"
                                        ...
                                        placeholder="Enter Name" value="{{ $subcategory->name }}" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="page_url" name="page_url" type="text" class="form-control"
                                        ...
                                        placeholder="Enter Page Url" value="{{ $subcategory->page_url }}" />
                                ...
                                <div class="form-group">
                                    ...
                                    @if($subcategory->image != '')
                                        <img src="{{ asset('public/upload/size_guide/small/'.$subcategory->image) }}" style="    width: 10%;margin-top: 10px;"/>
                                    @endif
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="meta_title" name="meta_title"
                                        ...
                                        placeholder="Enter Meta Title" value="{{ $subcategory->meta_title }}">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="meta_keywords" name="meta_keywords"
                                        ...
                                        placeholder="Enter Meta Keywords" value="{{ $subcategory->meta_keywords }}">
