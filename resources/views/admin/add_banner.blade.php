                    ...
                    <div class="card-body">
                        ...
                        <form id="banner_form" action="{{ route('banner.store') }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="name">App Image(1500px x 1000px)</label>
                                        <input id="app_image" name="app_image" type="file" class="form-control"
                                            value="" />
                                        <p id="app_image_error" style="display: none;color: red"></p>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
...
@section('footer_js')
    ...
    <script>
        function cms_validation() {
            ...
            var app_image = jQuery("#app_image").val();
            if (app_image == '') {
                jQuery('#app_image_error').html("Please Select Image");
                jQuery('#app_image_error').show().delay(0).fadeIn('show');
                jQuery('#app_image_error').show().delay(2000).fadeOut('show');
                $('html, body').animate({
                    scrollTop: $('#app_image').offset().top - 150
                }, 1000);
                return false;
            }
