                            ...
                            <div class="row">
                                                ...
                                                <div class="form-group"> <label for="categoryname">Colour</label>
                                                    ...
                                                    <select class="form-control" id="colouru" name="colouru[]">
                                                        ...
                                                        @foreach ($colour as $colour_data)
                                                            ...
                                                            <option value="{{ $colour_data->id }}"

                                                                @if ($attribute_data[$i]->colour_id == $colour_data->id) {{ 'selected' }} @endif>

                                                                {{ $colour_data->name }}</option>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="description" name="description" class="form-control" placeholder="Enter Description">{{ $product->description }}</textarea>
