    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            ...
            <div class="row align-items-center">
                ...
                @if (in_array('19', $edit_perm))
                    <div class="col-auto">



                        <a class="btn btn-primary me-1" href="{{ route('testimonials.create') }}">
            ...
            <div class="col-sm-12">
                ...
                <div class="card card-table">
                    ...
                    <div class="card-body">
                        ...
                        <form id="form" action="{{ route('delete_testimonials') }}" enctype="multipart/form-data">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($testimonials as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ url('public/upload/testimonials/large/' . $data->image) }}"
                                                ...
                                                @if (in_array('19', $edit_perm))
                                                    <td class="text-right">
                                                        ...
                                                        <a class="btn btn-primary"
                                                            href="{{ route('testimonials.edit', $data->id) }}"><i
