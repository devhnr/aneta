    ...
    public function order_place(){
       ...
       if($checkout_address_already != ''){
        ...
        $shiaddress_data=array(          
            ...
            'bill_address1'     => $_POST['address1'],
            //'bill_address2'     => $_POST['bill_address2'],
            'bill_city'         => $_POST['city'],
            'bill_post_code'    => $_POST['post_code'],
            'bill_country'      => $_POST['country'],
            'bill_state'        => $_POST['state'],
            'bill_phone_number' => $_POST['phone'],
            'bill_email_address'=> $_POST['email_id'],
            'user_id'=> $userid,
        ...
        foreach(\Cart::content() as $arrRowDeailts){
                ...
                $arrData=array(
                        ...
                        'package_detail'         => $arrRowDeailts->options->package_detail,
    ...
    <body style="margin: 0;font-family: Arial, Helvetica, sans-serif;">
        ...
        <div style="max-width:630px;margin: 0 auto;border: thin solid #f3f0f0;">
            ...
            <header style="text-align:center;"><meta http-equiv="Content-Type" content="text/html; charset=euc-jp">
                ...
                <a href="{{ config("app.url") }}"><img style="max-width:100%;display: inline-block;" src="'.asset("public/site/assets/img/logo.png").'"></a>           </header>
            ...
            <div style="background:#EDEDED;padding: 20px 7%;font-size: 14px;text-align: left;">
                ...
                <div style="width:44%;background:#EDEDED;text-align: left;display: inline-block;margin-bottom: 10px;">
                    ...
                    '.$shiaddress->address1.' ,'.$shiaddress->city.','.$shiaddress->state.','.$shiaddress->country.'- '.$shiaddress->post_code.'
            ...
            <div style="padding: 0px 30px;">
...

                {
                    ...
                    $message_body .='<td style="text-align: left;vertical-align: top;padding-left: 15px;padding-bottom: 10px;">
                        ...
                        <p style="margin: 0;"><span style="color:gray;">Size:</span> '.$arrRowDeailts->size_name.' | <span style="color:gray;">Quantity:</span> '.$arrRowDeailts->product_quantity.'| <span style="color:gray;">Package Detail:</span> '.$arrRowDeailts->package_detail.'</p><br>
...
$subject = "Thank you for shopping with Aneta";
