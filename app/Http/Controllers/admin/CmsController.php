...

{
...

    {
        ...
        return redirect()->route('cms.index')->with('success','CMS data added successfully');
...

    {
        ...
        return redirect()->route('cms.index')->with('success','CMS data Updated successfully');
...

    {
        ...
        return redirect()->route('cms.index')->with('success','CMS data Deleted successfully');
